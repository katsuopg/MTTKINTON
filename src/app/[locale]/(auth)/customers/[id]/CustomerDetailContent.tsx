      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleBack}
              disabled={isPending || isNavigating}
              className="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center"
            >
              {(isPending || isNavigating) && (
        ...
        {isNavigating && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center">
            <div className="bg-white p-4 rounded-lg shadow-lg flex items-center">
              ...
              <span className="text-gray-700">{language === 'ja' ? '読み込み中...' : language === 'th' ? 'กำลังโหลด...' : 'Loading...'}</span>
            </div>
          </div>
        )}
              ...
              <div className="flex items-center space-x-8">
                <div className="flex items-center">
                  ...
                  {customerRecord.TEL?.value ? (
                    <a href={`tel:${customerRecord.TEL.value}`} className="text-sm text-blue-600 hover:text-blue-500">
                      {customerRecord.TEL.value}
                    </a>
                  ) : <span className="text-sm text-gray-900">-</span>}
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-900">{customerRecord.FAX?.value || '-'}</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-900">{customerRecord.文字列__1行__6?.value || '-'}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-b border-gray-200 mb-6">
          <nav className="-mb-px flex space-x-8" aria-label="Tabs">
            ...
            >
              <DocumentIcon className={`mr-3 h-5 w-5 inline-block ${activeTab === 'workno' ? 'text-blue-600' : 'text-gray-400'}`} />
              {language === 'ja' ? '工事番号一覧' : language === 'th' ? 'รายการหมายเลขงาน' : 'Work No. List'}
              <span className={`ml-2 px-2 py-0.5 text-xs font-medium rounded-full ${
                activeTab === 'workno' ? 'bg-blue-600 text-white' : 'bg-blue-100 text-blue-800'
              }`}>
                {workNoData.length}
              </span>
            </button>
            ...
            >
              ...
              <span className={`ml-2 px-2 py-0.5 text-xs font-medium rounded-full ${
                activeTab === 'quotation' ? 'bg-green-600 text-white' : 'bg-green-100 text-green-800'
              }`}>
            ...
            >
              <ShoppingCartIcon className={`mr-3 h-5 w-5 inline-block ${activeTab === 'po' ? 'text-blue-600' : 'text-gray-400'}`} />
            ...
            >
              <DocumentIcon className={`mr-3 h-5 w-5 inline-block ${activeTab === 'invoice' ? 'text-blue-600' : 'text-gray-400'}`} />
            ...
            >
              <CogIcon className={`mr-3 h-5 w-5 inline-block ${activeTab === 'machine' ? 'text-blue-600' : 'text-gray-400'}`} />
            ...
            >
              <UserIcon className={`mr-3 h-5 w-5 inline-block ${activeTab === 'staff' ? 'text-blue-600' : 'text-gray-400'}`} />
            ...
            <div className="px-2 py-2">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="workno-period" className="text-sm font-medium text-gray-700">
              ...
              {isLoadingData ? (
                <div className="flex justify-center items-center py-8">
                  ...
                  <span className="ml-2 text-gray-600">{language === 'ja' ? '読み込み中...' : language === 'th' ? 'กำลังโหลด...' : 'Loading...'}</span>
                </div>
              ) : workNoData.length === 0 ? (
                <p className="text-gray-500">{language === 'ja' ? 'データがありません' : language === 'th' ? 'ไม่มีข้อมูล' : 'No data available'}</p>
              ) : (
                <div className="overflow-x-auto">
                  <table className="divide-y divide-gray-200 w-auto">
          ...
          {activeTab === 'quotation' && (
            <div className="px-2 py-2">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="quote-period" className="text-sm font-medium text-gray-700">
                    {language === 'ja' ? '会計期間:' : language === 'th' ? 'ปีบัญชี:' : 'Fiscal Year:'}
                  </label>
                  <select
                    id="quote-period"
                          ...
                          >
                            <td className="px-2 py-2 whitespace-nowrap text-sm">
                              <TransitionLink
                                ...
                                className={`font-medium ${isCancelled ? 'text-gray-400 hover:text-gray-600' : 'text-indigo-600 hover:text-indigo-900'}`}
                              >
                                {record.qtno2?.value || '-'}
                              </TransitionLink>
                            </td>
                            <td className="px-2 py-2 whitespace-nowrap text-sm">
                              {record.Text_0?.value ? (
                                <TransitionLink
                                  ...
                                  className={isCancelled ? 'text-gray-400 hover:text-gray-600' : 'text-indigo-600 hover:text-indigo-900'}
                                >
                                  {record.Text_0.value}
                                </TransitionLink>
                              ) : (
                            ...
                            <td className={`px-2 py-2 text-sm ${isCancelled ? 'text-gray-400' : 'text-gray-900'}`}>
                            ...
                            <td className={`px-2 py-2 whitespace-nowrap text-sm text-right ${isCancelled ? 'text-gray-400' : 'text-gray-900'}`}>
                              {(() => {
                                // grand_totalを試す
                            ...
                            <td className={`px-2 py-2 whitespace-nowrap text-sm ${isCancelled ? 'text-gray-400' : 'text-gray-900'}`}>
          ...
          {activeTab === 'po' && (
            <div className="px-2 py-2">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="po-period" className="text-sm font-medium text-gray-700">
                    {language === 'ja' ? '会計期間:' : language === 'th' ? 'ปีบัญชี:' : 'Fiscal Year:'}
                  </label>
                  <select
                    id="po-period"
          ...
          {activeTab === 'invoice' && (
            <div className="px-2 py-2">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <label htmlFor="invoice-period" className="text-sm font-medium text-gray-700">
                    {language === 'ja' ? '会計期間:' : language === 'th' ? 'ปีบัญชี:' : 'Fiscal Year:'}
                  </label>
                  <select
                    id="invoice-period"
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {invoiceData.map((record, index) => {
                        ...
                        <tr key={record.$id.value} className="hover:bg-gray-50">
                          ...
                          <td className="px-2 py-2 whitespace-nowrap text-sm text-right font-medium text-gray-900">
                        ...
                        <tr key={record.$id.value} className="hover:bg-gray-50">
                          ...
                          <td className="px-2 py-2 whitespace-nowrap text-sm text-gray-900">
                            {record.メールアドレス?.value ? (
                              <a href={`mailto:${record.メールアドレス.value}`} className="text-blue-600 hover:text-blue-500">
                                {record.メールアドレス.value}
                              </a>
                            ) : (
                              '-'
                          ...
                          <td className="px-2 py-2 whitespace-nowrap text-sm text-gray-900">
                            {record.TEL?.value ? (
                              <a href={`tel:${record.TEL.value}`} className="text-blue-600 hover:text-blue-500">
                                {record.TEL.value}
                              </a>
                            ) : (
                              '-'
                          ...
                          <td className="px-2 py-2 whitespace-nowrap text-sm text-gray-900">
                            {record.文字列__1行__7?.value ? (
                              <a href={`tel:${record.文字列__1行__7.value}`} className="text-blue-600 hover:text-blue-500">
                                {record.文字列__1行__7.value}
                              </a>
                            ) : (
                              '-'
