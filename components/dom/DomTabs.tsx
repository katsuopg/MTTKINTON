...
interface DomTabsProps {
  ...
  selectedMechItems: Set<string>;
  selectedElecItems: Set<string>;
  onToggleMechItem: (id: string) => void;
  onToggleElecItem: (id: string) => void;
}
...
export default function DomTabs({ dom, masters, language, onRefresh, workNo, projectCode, quoteSelecting, selectedMechItems, selectedElecItems, onToggleMechItem, onToggleElecItem }: DomTabsProps) {
    ...
    <div>
      ...
      <TabPanel value="mech" activeValue={activeTab}>
        <MechItemsTab
          ...
          onToggleQuoteItem={onToggleMechItem}
        />
      </TabPanel>
      ...
      <TabPanel value="elec" activeValue={activeTab}>
        <ElecItemsTab
          ...
          onToggleQuoteItem={onToggleElecItem}
        />
      </TabPanel>
